...
def selection_sort(arr):
    ...
    return result  # placeholder so the file runs
...
#    TODO: write your answer here O(n) * O(n) = O(n^2)
#
...
#    than O(1/2 * n^2)?
#    TODO: write your answer here 1/2 * n^2 is an exponent multiplied by a constant, which is dropped in big O notation. Hence, it simplifies to O(n^2)
#
...
#    TODO: write your answer here Removing an element costs O(n). This does not change the overall big O running time of the sort.
